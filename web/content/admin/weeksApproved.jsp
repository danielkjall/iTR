<%@page import="com.intiro.itr.logic.weekreport.WeekReport"%>
<%@page import="com.intiro.itr.ITRResources"%>
<%@page import="com.intiro.itr.logic.admin.ApprovedWeeks"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.intiro.itr.common.Common"%>
<%@page import="java.util.Calendar"%>
<%@page import="com.intiro.itr.util.personalization.UserProfile"%>
                            ...
                            <select name="__user" onchange="window.location.replace('weeksApproved.jsp?year=<%=year%>&userId=' + document.weeks.__user[document.weeks.__user.selectedIndex].value)">
                                ...
                                <% int sep = 0;   //position of separator
                                  ...
                                  for (int i = 0; i < users.size(); i++) {
                                    ...
                                    if (userId.length() > 0) {
                                      if (Integer.parseInt(userId) == Integer.parseInt(users.get(i).toString().substring(0, sep))) {
                                        selected = "selected";
                                      }
                                    }
                                %>

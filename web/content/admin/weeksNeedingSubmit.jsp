...
<%
      ...
      WeeksNeedingSubmit xmlCarrier = new WeeksNeedingSubmit(userProfile, "View");
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	<head>
		...
		<title>ITR - Weeks Needing Submit</title>
	</head>
		...
		<form action="#" name="weeks">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr bgcolor="#aaaacc" align="center">
					<td class="Title1"> Weeks Needing Submit</td>
				</tr>
			</table>
			<p>
			<table WIDTH="800" border="0" cellpadding="1" cellspacing="1" align="center">
                        <tr>
                            <td colspan="12">
                                <select name="__year" onchange="window.location.replace('weeksNeedingSubmit.jsp?year=' + document.weeks.__year[document.weeks.__year.selectedIndex].value)">
                                    <%
                                    java.util.Calendar cal = java.util.Calendar.getInstance();

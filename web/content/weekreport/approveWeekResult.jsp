<%@ page session="true"%>
<%@ page import="java.util.*, com.intiro.itr.ITRResources, com.intiro.itr.logic.weekreport.WeekReport, com.intiro.itr.util.personalization.UserProfile, com.intiro.itr.util.log.IntiroLog"%>

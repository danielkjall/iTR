<%@ page session="true"%>
<%@ page import="com.intiro.itr.util.xml.XMLCombo.Entry, com.intiro.itr.ITRResources, com.intiro.itr.util.personalization.*, com.intiro.itr.logic.superadmin.projects.ProjectActivitiesQueryProfile"%>
<%
	response.setHeader("Cache-Control", "no-cache");
	response.setHeader("Pragma", "no-cache");
	response.addHeader("Cache-Control","no-store");
    UserProfile userProfile = (UserProfile) session.getAttribute(ITRResources.ITR_USER_PROFILE);
	ProjectActivitiesQueryProfile xmlCarrier = new ProjectActivitiesQueryProfile(userProfile);
%>
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	<head>
		...
		<script type="text/javascript">
			...
			<title>ITR - Super admin - Modify Project Activities</title>
		...
		<center>
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr bgcolor="#aaaacc" align="center">
					<td class="Title1">Super Admin - Modify Project Activities</td>
				</tr>
			</table>
				...
				<p>
					<table cellspancing="0" cellpadding="0" border="0" width="300">
						...
						<form method="POST" action="changeProjectActivities.jsp" name="queryprofile" onsubmit="return validate(this)">
						<tr>
						...
						<tr>
							<td align="right" colspan="2">
								<input type="submit" name="btnModify" value="Modify project activities" class="input"/>
								&#160;

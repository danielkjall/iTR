<%@ page session="true"%>
<%@ page import="com.intiro.itr.util.xml.XMLCombo.Entry, com.intiro.itr.ITRResources, com.intiro.itr.util.personalization.*, com.intiro.itr.logic.superadmin.projects.ProjectQueryProfile"%>
<%
	response.setHeader("Cache-Control", "no-cache");
	response.setHeader("Pragma", "no-cache");
	response.addHeader("Cache-Control","no-store");
    UserProfile userProfile = (UserProfile) session.getAttribute(ITRResources.ITR_USER_PROFILE);
	ProjectQueryProfile xmlCarrier = new ProjectQueryProfile(userProfile);
%>
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	<head>
		...
		<title>ITR - Super admin - Modify Project</title>
		...
		<center>
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr bgcolor="#aaaacc" align="center">
					<td class="Title1">Super Admin - Modify Project</td>
				</tr>
			</table>
				...
				<p>
					<table cellspancing="0" cellpadding="0" border="0" width="300">
						...
						<form method="POST" action="changeProjects.jsp" name="queryprofile" onsubmit="return validate(this)">
						<tr>
						...
						<tr>
							<td colspan="2" align="right">
								<input type="button" name="btnAdd" value="&#160;&#160;&#160;Add&#160;&#160;&#160;" class="input" onclick="document.location.href='changeProjects.jsp?btnAdd=Add'">
								</input>
								&#160;

...
<form method="POST" action="UserQueryView" name="personalinfo">
<p>
      <table cellspancing="0" cellpadding="0" border="0" width="300" align="center">
        ...
        <tr> 
          <td  class="NormalBold" width="50%" align="left">Tried to change the user: </td>
	 ...
	 <tr> 
          ...
          <td align="left" width="50%"> 
            <input type="submit" name="activator" value=" Ok " class="input"/>
            </td>
        </tr>
      </table>
</p>

<%@ page session="true"%>
<%@ page import="com.intiro.itr.util.xml.XMLCombo.Entry, com.intiro.itr.ITRResources, com.intiro.itr.util.personalization.*, com.intiro.itr.logic.superadmin.users.EmailQueryProfile"%>
<%
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	<head>
		...
		<title>ITR - Super admin - Modify Phone Numbers</title>
		...
		<center>
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr bgcolor="#aaaacc" align="center">
					<td class="Title1">Super Admin - Modify Phone Numbers</td>
				</tr>
			</table>
			<form method="POST" action="changePhones.jsp" name="queryprofile" onsubmit="return validate(this)">
					...
					<table cellspancing="0" cellpadding="0" border="0" width="300">
						...
						<tr>
							<td colspan="2" align="right">
								<input type="submit" name="btnAdd" value="Modify phone numbers" class="input"/>&#160;

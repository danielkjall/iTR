<%@ page session="true"%>
<%@ page import="com.intiro.itr.util.xml.XMLCombo.Entry, com.intiro.itr.ITRResources, com.intiro.itr.util.personalization.*, com.intiro.itr.logic.superadmin.activity.ActivityQueryProfile"%>
<%
	...
	<head>
		...
		<script type="text/javascript">
			...
			function validate(theForm)  {
				//Activity
    			if ( !isSelected(theForm.activity, "Activity") )
        			return false;
 				return true;
			}
		</script>
		<title>ITR - Super admin - Modify Activity</title>
		...
		<center>
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr bgcolor="#aaaacc" align="center">
					<td class="Title1">Super Admin - Modify Activity</td>
				</tr>
			</table>
			<form method="POST" action="changeActivity.jsp" name="queryprofile" onsubmit="return validate(this)">
			<table cellspancing="0" cellpadding="0" border="0" width="300">
				...
				<tr>
					<td class="NormalBold" align="left" width="50%"> Activity </td>
					<td align="left" width="50%">
						<select name="activity" class="input">
						<%
						for(int i=0;i<xmlCarrier.getActivityCombo().getEntries().size(); i++) {
							Entry anEntry = (Entry)xmlCarrier.getActivityCombo().getEntries().get(i);
						%>
				...
				<tr>
					<td colspan="2" align="right">
						<input type="button" name="btnAdd" value="&#160;&#160;&#160;Add&#160;&#160;&#160;" class="input" onclick="document.location.href='changeActivity.jsp?btnAdd=Add'">
						</input>
						&#160;
				...
				<tr>
					<td align="right" colspan="2">
						<input type="button" name="Cancel" value=" Cancel " onclick="window.location.href='mainFrame.jsp'" class="input"/>
					</td>
				</tr>
			</table>
			</form>	

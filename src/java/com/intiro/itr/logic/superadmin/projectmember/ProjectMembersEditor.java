...
public class ProjectMembersEditor extends DynamicXMLCarrier {
  ...
  protected Vector <ProjectMember> assignedMembers = new Vector <ProjectMember> ();
  protected Vector <ProjectMember> availableMembers = new Vector <ProjectMember> ();
   ...
   */
  public Vector getAssignedProjectActivities() {
    if (IntiroLog.d()) {
  ...
  public void setAssignedProjectMember(ProjectMember onePM) {
    ...
    assignedMembers.addElement(onePM);
  }
  ...
  public ProjectMember getAssignedProjectMember(int id) {
    ...
    for (int i = 0; i < assignedMembers.size(); i++) {
      ...
      if (onePM != null && onePM.getId() == id && onePM.getStillAssigned()) { return onePM; }
    }
  ...
  public void setAvailableMember(ProjectMember onePM) {
    availableMembers.addElement(onePM);
  }
  ...
  public ProjectMember getAvailableProjectMember(int id) {
    ...
    for (int i = 0; i < availableMembers.size(); i++) {
      ...
      if (onePM != null && onePM.getITR_UserId() == id) { return onePM; }
    }
   ...
   */
  public Vector<ProjectMember> getAssignedMembers() {
    return assignedMembers;
  }
  /**
   * @return Returns the availableMembers.
   */
  public Vector<ProjectMember> getAvailableMembers() {

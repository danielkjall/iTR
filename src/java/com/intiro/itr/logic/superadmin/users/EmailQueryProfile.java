...
public class EmailQueryProfile extends DynamicXMLCarrier {
  ...
  public EmailQueryProfile(UserProfile profile) throws XMLBuilderException {
    super(profile);

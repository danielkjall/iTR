...
public class ProjectActivitiesQueryProfile extends DynamicXMLCarrier {
  ...
  public ProjectActivitiesQueryProfile(UserProfile profile) throws XMLBuilderException {
    super(profile);

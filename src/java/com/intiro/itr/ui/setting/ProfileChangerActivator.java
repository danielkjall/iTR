...
import com.intiro.itr.logic.setting.UserProfileChangerActivator;
...
public class ProfileChangerActivator extends ITRServlet implements URLs, Commands {
  //~ Methods ..........................................................................................................
  ...
  public void doGet( HttpServletRequest request, HttpServletResponse response )
    ...
    try {
      ...
      UserProfileChangerActivator changer = new UserProfileChangerActivator( userProfile );
      changer.changeUserProfile( request.getParameter( Commands.XSLFIELD_FIRSTNAME ), 
                                 request.getParameter( Commands.XSLFIELD_LASTNAME ), 
                                 request.getParameter( Commands.XSLFIELD_LANGUAGE ), 
                                 request.getParameter( Commands.XSLFIELD_SKIN ) );
      xmlCarrier.add( changer );

      XSLFormatedArea xslPassResult = new XSLFormatedArea( xmlCarrier, CHANGE_PROFILE_RESULT_HTML_XSL );

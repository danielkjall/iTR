...
import com.intiro.itr.logic.generatereport.general.QueryProfile;
 ...
 */
public class GeneralQueryProfileView extends ITRServlet implements URLs, Commands {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException {
    ...
    try {
      ...
      XSLFormatedArea xslWeeks = new XSLFormatedArea(xmlCarrier, GENERAL_QUERY_PROFILE_HTML_XSL);
      page.add(xslWeeks);

...
public class CornerFrame extends ITRServlet implements URLs, Commands {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException {
    ...
    try {
      ...
      StaticXMLCarrier xmlCarrier = new StaticXMLCarrier(CORNER_XML, userProfile);
      XSLFormatedArea xslCorner = new XSLFormatedArea(xmlCarrier, CORNER_HTML_XSL);
      page.add(xslCorner);
      ...
      errorHandler.setErrorMessage("A problem occured when trying to display the CornerFrame page.");

...
import com.intiro.itr.logic.superadmin.projects.ProjectActivitiesQueryProfile;
...
public class ProjectActivitiesQueryView extends ITRServlet implements URLs, Commands {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException {
    ...
    try {
      ...
      XSLFormatedArea xslProjActivities = new XSLFormatedArea(xmlCarrier,
              SUPERADMIN_PROJECTS_ACTIVITIES_QUERY_HTML_XSL);
      page.add(xslProjActivities);

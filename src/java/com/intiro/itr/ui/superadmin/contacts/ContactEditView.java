...
public class ContactEditView extends ITRServlet implements URLs, Commands {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException {
    ...
    try {
      ...
      if (IntiroLog.d()) {
        IntiroLog.detail(getClass(), getClass().getName() + ".doGet(): mode=" + mode + " contactId = " + contactId);
      }
      ...
      XSLFormatedArea xslUser = new XSLFormatedArea(xmlCarrier, SUPERADMIN_CONTACT_CHANGE_HTML_XSL);
      page.add(xslUser);

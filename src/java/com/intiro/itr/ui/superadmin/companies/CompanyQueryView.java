...
import com.intiro.itr.logic.superadmin.companies.CompanyQueryProfile;
...
public class CompanyQueryView extends ITRServlet implements URLs, Commands {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException {
    ...
    try {
      ...
      XSLFormatedArea xslComp = new XSLFormatedArea(xmlCarrier, SUPERADMIN_COMPANIES_QUERY_HTML_XSL);
      page.add(xslComp);

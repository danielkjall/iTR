...
public class HtmlPage extends Page implements URLs {
  ...
  protected Vector <String> javaScripts = new Vector <String> (5);
  ...
  protected Vector <String> scriptsInHeader = new Vector <String> (5);
  protected String textFont = null;
  protected String title = new String("No Title");
  protected String topMargin = null;
  protected Vector <XSLFormatedArea> xslScriptsInHeader = new Vector <XSLFormatedArea> (5);
   ...
   * Use this constructor only from LoginView because it doesn't require
   * a session.
   */
  ...
  public HtmlPage(HttpServletRequest request) throws UIException, NoSessionException {
    ...
    if (request.getSession(false) == null) { throw new NoSessionException("No session was found."); }
  }
  ...
  public synchronized void setBGColor(String newColor) throws UIException {
    ...
    if (newColor == null) { throw new UIException(myName + ":Background color cannot be null"); }
  ...
  public synchronized void setCssClass(String cssClass) throws UIException {
    ...
    if (cssClass == null) { throw new UIException(myName + ":cssClass can not be null"); }
  ...
  public synchronized void setLeftMargin(String newLeftMargin) throws UIException {
    ...
    if (newLeftMargin == null) { throw new UIException(myName + ":Left margin cannot be null"); }
  ...
  public synchronized void setMarginHeigth(String newHeigth) throws UIException {
    ...
    if (newHeigth == null) { throw new UIException(myName + ":Margin heigth cannot be null"); }
  ...
  public synchronized void setMarginWidth(String newWidth) throws UIException {
    ...
    if (newWidth == null) { throw new UIException(myName + ":Margin width cannot be null"); }
  ...
  public synchronized void setOnLoadCall(String callScript) throws UIException {
    ...
    if (callScript == null) { throw new UIException(myName + ":OnLoad can not be null"); }
  ...
  public synchronized void setTextFont(String newText) throws UIException {
    ...
    if (newText == null) { throw new UIException(myName + ":Text font cannot be null"); }
  ...
  public synchronized void setTopMargin(String newTopMargin) throws UIException {
    ...
    if (newTopMargin == null) { throw new UIException(myName + ":Background color cannot be null"); }
  ...
  public synchronized void add(UIElement newElement) throws UIException {
    ...
    if (newElement instanceof HtmlPage) { throw new UIException(myName + ":Can't add a Page to Page " + getName()); }
  ...
  public synchronized void addJavaScriptReference(String scriptURL) {
    if (scriptURL.length() != 0 && scriptURL != null) {
      javaScripts.addElement(ITRResources.getDefaultProtocolForITR() + ITRResources.getDefaultWebITRRootDir() + JAVASCRIPT_DIR + scriptURL);
    }
  }
  ...
  public synchronized void addScriptToHeader(XSLFormatedArea xslFormatedArea) {
    if (xslFormatedArea != null) {
      xslScriptsInHeader.addElement(xslFormatedArea);
    }
  }
  ...
  public synchronized void addScriptToHeader(String script) {
    if (script != null) {
      scriptsInHeader.addElement(script);
    }
  }
  ...
  public void display(PrintWriter out, ClientInfo inClientInfo, String inEServiceName) throws UIException {
    ...
    if (javaScripts != null && !javaScripts.isEmpty()) {
      String oneScriptRef = new String();

      for (Enumeration e = javaScripts.elements(); e.hasMoreElements();) {
        oneScriptRef = (String) e.nextElement();
    ...
    if (xslScriptsInHeader != null && !xslScriptsInHeader.isEmpty()) {
      XSLFormatedArea oneXSLArea = null;

      for (Enumeration e = xslScriptsInHeader.elements(); e.hasMoreElements();) {
        oneXSLArea = (XSLFormatedArea) e.nextElement();
        oneXSLArea.display(out);
      }
    }
    //Add Script to the head of the page.
    if (scriptsInHeader != null && !scriptsInHeader.isEmpty()) {
      String oneScript = null;

      for (Enumeration e = scriptsInHeader.elements(); e.hasMoreElements();) {
        oneScript = (String) e.nextElement();

...
/**
 * This class acts as an ADORecordset, but is implemented as strings and
 * ArrayLists
 */
public class StringRecordset {
    ...
    /**
     * Delimiter that is used to separate fields in import/export from/to
     * StringRecordset
     */
    public static final String FIELD_DELIMITER = "|";

    /**
     * Delimiter that is used to separate rows in import/export from/to
     * StringRecordset
     */
    ...
    public double getDouble(int ix) throws Exception {
        ...
        try {
            String tmpValue = getField(ix);
            if (ItrUtil.isStrContainingValue(tmpValue)) {
                tmpValue = tmpValue.replace(',', '.');
            }
            val = Double.parseDouble(tmpValue);
        } catch (Exception e) {
    ...
    /**
     * Close the recordset. Should always be done after you used the
     * StringRecordset
     */
    public void close() {
        moveFirst();

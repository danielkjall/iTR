...
public class ITRCalendar extends GregorianCalendar {
  ...
  private Vector <ITRCalendar> datesInWeek = new Vector <ITRCalendar> ();
  ...
  /**
  * Constructor II for ITRCalendar.
  * This constructor calls loadCalendarWithDate(String loadString);
  * The format of loadString must be:
  * [YEAR-MONTH-DATE]
  * Ex. 2000-12-31
  *
  ...
  */
  ...
  public static void test() {
    ...
    /*    ITRCalendar now = new ITRCalendar();
        try {
    //      now.loadCalendarWithDate("2001-01-28");
          now.loadCalendarWithDate("01/01/2001");
        }catch(Exception e){}
     try {
          StringRecordset rs = new DBQueries(user).getRowsInUserWeek(now.getCalendarInStoreFormat());
        } catch(Exception e) {
            IntiroLog.info(".load(): ERROR FROM DATABASE, exception = " + e.getMessage());
        }
    */

    /*
        ITRCalendar nowPlusOneMonth = new ITRCalendar();
        nowPlusOneMonth.nextMonth();
        nowPlusOneMonth.nextMonth();
        ITRCalendar currentDate = now.cloneCalendar();
        IntiroLog.detail("now = " + now);
        IntiroLog.detail("currentDate = " + currentDate);
        IntiroLog.detail("nowPlusOneMonth = " + nowPlusOneMonth);
        //First create all weeks between now and nowPlusSixMonth.
        while(true) {
            //next weekpart, it rolls to next week if needed.
            //IntiroLog.detail("Before nextWeekPart(): currentDate = " + currentDate);
            IntiroLog.detail("---------------------------------------------------------------------------------------------------");
            IntiroLog.detail("currentDate = " + currentDate);
            IntiroLog.detail("currentDate.getWeekOfYear(): "+currentDate.getWeekOfYear());
            IntiroLog.detail("currentDate.getWeekPart(): "+currentDate.getWeekPart());
            IntiroLog.detail("currentDate.isWeekSplit(): "+currentDate.isWeekSplit());
            IntiroLog.detail("currentDate.getFromDateForWeekPart(): "+currentDate.getFromDateForWeekPart());
            IntiroLog.detail("currentDate.getToDateForWeekPart(): "+currentDate.getToDateForWeekPart());
            currentDate.nextDate();
            //break loop if when have passed nowPlusOneMonth.
            if(nowPlusOneMonth.before(currentDate))
              break;
        }
  ...
  /**
  * Get Calendar date in store format.
  ...
  */
  public String getCalendarInStoreFormat() {
    ...
    /*
        ...
        retval.append(DATE_SEPARATOR_SLASH);
  ...
  */
  public Vector getDatesInWeekPart() {
  ...
  /**
  * Get the day name in the long version.
  * Ex. Monday, Tuesday, .... Sunday.
  */
  ...
  /**
  * Get the day name in the short version.
  * Ex. mon, tue, .... sun.
  */
  ...
  */
  ...
  //MONTH
  /**
  * Sets the month using Calendars method set(int field, int value).
  * The value retrived is subtracted with 1, since month are 0 indexed.
  * Ex.
  * January = 1
  * February = 2
  * ....
  ...
  */
  ...
  /**
  * Gets the month using Calendars method get(int field).
  * The value retruned is added with 1, since month are 0 indexed.
  */
  public int getMonth() {
  ...
  * @retrun   a Vector with the first date of each weekpart in the year.
  */
  public Vector <ITRCalendar> getWeekPartsOfYear() {

    //IntiroLog.detail(getClass().getName()+".getWeekPartsOfYear(): Entering");
    Vector <ITRCalendar> retval = new Vector <ITRCalendar> ();
  ...
  */
  ...
  /**
  * Load the calendar with a specific date.
  * Usely this is retrived directly from the database.
  * The format of loadString must be:
  * [YEAR-MONTH-DATE] Ex. 2000-12-31
  * [MONTH/DATE/YEAR] Ex. 12/31/2000
  * or
  * [YEAR-MONTH-DATE HOURS:MINUTES:SECONDS] Ex. 2000-12-31 12:52:13
  ...
  */
  ...
  /**
  * Set calendar to the next date, using Calendars method roll(int field, boolean up).
  * Moves into next month if nessessary.
  * Ex. if nextDate() is called when date is 2000-11-30, it will be set to 2000-12-01.
  */
  ...
  /**
  * Roll month up.
  * Moves into next year if nessessary.
  * Ex. if nextMont() is called when date is 2000-12-30, it will be set to 2001-01-30
  */
  ...
  */
  ...
  /**
  * Roll week or weekpart up.
  * If week 4 is split and calendar is in week 4_1 and nextWeekPart() is called it rolls up to week 4_2.
  * If calendar is week 4_2 it is rolled up to week 5_1.
  * It stays on first date of the new week or weekpart.
  * If a new year is hit the calendar is rolled up to this new year.
  */
  ...
  */
  ...
  /**
  * Set calendar to the previous date, using Calendars method roll(int field, boolean up).
  * Moves into previous month if nessessary.
  * Ex. if previousDate() is called when date is 2000-11-01, it will be set to 2000-10-31.
  */
  ...
  */
  ...
  /**
  * Roll week down.
  * Stays on SUNDAY the previous week.
  */

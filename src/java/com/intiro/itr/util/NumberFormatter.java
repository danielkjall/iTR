...
public class NumberFormatter {
  ...
  /**
    * Formats a number string to the format '###,##0.#'
    * Returns 'N/A' if something went wrong.
    * Ex. 12456.78 -> 12 456
    * Ex. 123456789 -> 123 456 789
    * <P>
    * @param       strVal      The number as a double
  ...
  /**
    * Formats a number string to the format '###,##0. <suffix>'
    * Suffix is the trailing letters after the number. ( k, M )
    * The return value are divided with 1 000 respectively 1 000 000.
    * Returns 'N/A' if something went wrong.
    * Ex. 12 456 k
    * Ex. 123 456 789 M
    * <P>
  ...
  public static String format( String strVal, String suffix, int noOfDecimals, boolean delimiter ) {
    ...
    try {
      ...
      double val = Double.valueOf( strVal ).doubleValue();
  ...
  /**
     * Formats a number Strings decimals if it ends with 0'
     * Ex. 123.300 -> 123.3
     * <P>
     * @param       strVal      The number string on format (###.###...) Ex. 123.300
     * @param       dec         The number of decimals that will show.
     * @return      A String on the format '###,##0.'
     */

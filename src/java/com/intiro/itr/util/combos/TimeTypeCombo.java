...
public class TimeTypeCombo extends XMLCombo {
  ...
  /**
   * Constructor I for TimeTypeCombo.
   * Creates a combo with a value = "null" and text = "Select".
   *
   *
   * @param    profile                the UserProfile of the user.
   */
  public TimeTypeCombo( UserProfile profile )
                throws XMLBuilderException {
    this( profile, "Select" );
  }
  /**
   * Constructor II for TimeTypeCombo.
   ...
   */
  public TimeTypeCombo( UserProfile profile, boolean makeNullEntry )
                throws XMLBuilderException {
    super( profile, makeNullEntry );
  }
  /**
   * Constructor III for TimeTypeCombo.
   ...
   */
  public TimeTypeCombo( UserProfile profile, String nameOnNullEntry )
                throws XMLBuilderException {
  ...
  public void load( String valueToBeSelected )
            throws XMLBuilderException {
    try {
      StringRecordset rs = dbQuery.getTimeTypes();

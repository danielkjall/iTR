...
public class CompanyCombo extends XMLCombo {
   ...
   */
  public CompanyCombo( UserProfile profile, boolean makeNullEntry )
               throws XMLBuilderException {
    super( profile, makeNullEntry );
  }
  /**
   * Constructor III for CompanyCombo.
   ...
   */
  public CompanyCombo( UserProfile profile, String nameOnNullEntry )
               throws XMLBuilderException {

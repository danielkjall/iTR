...
public class SkinsCombo extends XMLCombo {
  ...
  /**
   * Constructor I for SkinsCombo. Creates a combo with a value = "null" and text = "Select skin".
   *
   *
   * @param profile the UserProfile of the user.
   */
  public SkinsCombo(UserProfile profile) throws XMLBuilderException {
    this(profile, "Select skin");
  }

  /**
   * Constructor II for SkinsCombo. Creates a combo with a value = "null" and text = "---------", if makeNullEntry is true.
   *
   * @param profile the UserProfile of the user.
   * @param makeNullEntry a boolean specifying if empty entry should be added.
   */
  public SkinsCombo(UserProfile profile, boolean makeNullEntry) throws XMLBuilderException {
    super(profile, makeNullEntry);
  }

  /**
   * Constructor III for SkinsCombo. Creates a combo with a value = "null" and text = nameOnNullEntry.
   *
   * @param profile the UserProfile of the user.
   * @param nameOnNullEntry a String specifying the name on the entry with value "null".
   */
  public SkinsCombo(UserProfile profile, String nameOnNullEntry) throws XMLBuilderException {

...
public class LanguageCombo extends XMLCombo {
  ...
  /**
   * Constructor I for LanguageCombo.
   * Creates a combo with a value = "null" and text = "Select language".
   *
   *
   * @param    profile                the UserProfile of the user.
   */
  public LanguageCombo( UserProfile profile )
                throws XMLBuilderException {
    this( profile, "Select language" );
  }
  /**
   * Constructor II for LanguageCombo.
   ...
   */
  public LanguageCombo( UserProfile profile, boolean makeNullEntry )
                throws XMLBuilderException {
    super( profile, makeNullEntry );
  }
  /**
   * Constructor III for LanguageCombo.
   ...
   */
  public LanguageCombo( UserProfile profile, String nameOnNullEntry )
                throws XMLBuilderException {
  ...
  public void load( String valueToBeSelected )
            throws XMLBuilderException {
    try {
      StringRecordset rs = dbQuery.getLanguages();
